...
type Configuration struct {
	Env         string `yaml:"env" env:"ENV" env-required:"true"`
	StoragePath string `yaml:"storage_path" env:"storage_path" env-required:"false"`
	SecretARN   string `yaml:"secret_arn" env:"secret_arn" env-required:"false"`
	RdsEndpoint string `yaml:"rds_endpoint" env:"rds_endpoint" env-required:"false"`
	HttpServer  `yaml:"http_server" env-required:"true"`
	SMTP        `yaml:"smtp" env-required:"true"`
}
...
func LoadConfiguration() *Configuration {
	...
	var configPath string
	configPath = os.Getenv("./Config/localConfig.yaml")
