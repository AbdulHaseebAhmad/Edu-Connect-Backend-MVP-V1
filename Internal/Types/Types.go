...
type University struct {
	...
	UniversityProfile        string `json:"university_profile"`
	UniversityBanner         string `json:"university_banner"`
	UniversityVideo          string `json:"university_gallery_video"`
	UniversityMain           string `json:"university_gallery_main"`
	UniversitySecondaryOne   string `json:"university_secondary_one"`
	UniversitySecondaryTwo   string `json:"university_secondary_two"`
	UniversitySecondaryThree string `json:"university_secondary_three"`
	UniversitySecondaryFour  string `json:"university_secondary_four"`
}
